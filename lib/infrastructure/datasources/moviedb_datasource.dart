import 'package:cinemapedia_220606/config/constants/environment.dart';
import 'package:cinemapedia_220606/domain/datasources/movies_datasource.dart';
import 'package:cinemapedia_220606/domain/entities/movie.dart';
import 'package:cinemapedia_220606/infrastructure/mappers/movie_mapper.dart';
import 'package:cinemapedia_220606/infrastructure/models/moviedb/moviedb_response.dart';
  ...
  Future<List<Movie>> getMexicanMovies({int page = 1}) async {
    final response = await dio.get(
      ...
      queryParameters: {
        ...
        'region': 'MX',
        'sort_by': 'vote_average.desc', // 🔹 Mejor calificadas
