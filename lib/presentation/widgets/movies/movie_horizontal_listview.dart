...
import 'package:cinemapedia_220606/config/helpers/human_formats.dart';
...
class _MovieHorizontalListviewState extends State<MovieHorizontalListview> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      ...
      // ✅ Detectar si ya casi llegamos al final
          ...
          SizedBox(
            ...
            child: Row(
              children: [
                ...
                Text(
                  // ✅ Quitar Flexible para que no se expanda
                  movie.voteAverage.toStringAsFixed(1),
                  style: textStyles.bodyMedium?.copyWith(
                    color: Colors.yellow.shade800,
                  ),
                ),
                const Spacer(), // ✅ Agregar Spacer aquí para separar rating de popularidad
                Flexible(
                  child: Text(
